	...
	<page-container>
		<div class="page-inner">
			<card-container class="card-container" :show-header="false">
				<div class="task">
					<div class="title">
						<svg-icon class="icon" name="dingsrw_icon"></svg-icon>定时任务-{{ type === 'add' ? '新增' : '修改' }}
					</div>
					<div class="container">
						<div class="content">
							<m-form ref="formRef" class="form" :model="form" :rules="rules">
								...
								<m-form-item label="执行时间" name="time">
...
<script setup lang="ts">
	...
	const rules = {
		...
		time: [{ type: 'array', required: true, message: '请选择执行时间', trigger: ['change', 'blur'] }],
