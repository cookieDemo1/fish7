<template>
	...
	<modal-device-add v-model="actions.showAddDevice" title="添加设备" @callback="handleAddDevice"> </modal-device-add>
	<modal-childtask-add v-model="actions.showAddTask" title="添加子任务" @callback="handleAddTask">
	</modal-childtask-add>
	<modal-time-picker v-model="actions.showAddTime" title="添加等待时长" @callback="handleAddTime"></modal-time-picker>
</template>
